...
\newcommand{\SUtwoL}{\Group{SU}{2}{L}}
\newcommand{\SUtwo}{\Group{SU}{2}{}}
\newcommand{\SUfive}{\Group{SU}{5}}
\newcommand{\Oten}{\Group{O}{10}}
\newcommand{\SUtwoR}{\Group{SU}{2}{R}}
\newcommand{\SUlrs}{\ensuremath{\SUtwoR \times \SUtwoL \times \Uone}\xspace}
\newcommand{\Uone}{\GroupShort{U}{1}}
\newcommand{\SUtwoUone}{\ensuremath{\SUtwoL \times \Uone}\xspace}
