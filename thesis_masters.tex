...
%\input{macros/from_ptr_definitions.tex}
...
\includeonly{
    ...
    chapters/intro,
    chapters/theory,
    chapters/BoostedPhysics,
    chapters/experiment,
    chapters/strategy,
    %chapters/event_selection,
    chapters/object_id_reco_corr,
    chapters/conclusion,
    chapters/app_glossary,
    %chapters/Systematic_Uncertainties,
    chapters/Limit_Setting,
    chapters/Background_Estimation
}
...
\include{chapters/BoostedPhysics}
%ANA chapters
\include{chapters/strategy}
\include{chapters/object_id_reco_corr}
%\include{chapters/event_selection}
\include{chapters/Background_Estimation}
%\include{chapters/Systematic_Uncertainties}
\include{chapters/Limit_Setting}
